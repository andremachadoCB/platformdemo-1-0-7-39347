...
export const getweather_get_data_25_weather_read = createAsyncThunk("getweather_response_get_GetWeatherbyCities/getweather_get_data_25_weather_read", async payload => {
  const response = await apiService.getweather_get_data_25_weather_read(payload);
