...
export const api_v1_attendevent_list = createAsyncThunk("attendEvents/api_v1_attendevent_list", async payload => {
  const response = await apiService.api_v1_attendevent_list(payload);
  return response.data;
});
export const api_v1_attendevent_create = createAsyncThunk("attendEvents/api_v1_attendevent_create", async payload => {
  const response = await apiService.api_v1_attendevent_create(payload);
  return response.data;
});
export const api_v1_attendevent_retrieve = createAsyncThunk("attendEvents/api_v1_attendevent_retrieve", async payload => {
  const response = await apiService.api_v1_attendevent_retrieve(payload);
  return response.data;
});
export const api_v1_attendevent_update = createAsyncThunk("attendEvents/api_v1_attendevent_update", async payload => {
  const response = await apiService.api_v1_attendevent_update(payload);
  return response.data;
});
export const api_v1_attendevent_partial_update = createAsyncThunk("attendEvents/api_v1_attendevent_partial_update", async payload => {
  const response = await apiService.api_v1_attendevent_partial_update(payload);
  return response.data;
});
export const api_v1_attendevent_destroy = createAsyncThunk("attendEvents/api_v1_attendevent_destroy", async payload => {
